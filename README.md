# 💸 Vibe Check: Finance, but make it Aesthetic.

<p align="center">
  <img src="https://img.shields.io/badge/UI-Midnight%20Neon-blueviolet?style=for-the-badge&logo=visualstudiocode" />
  <img src="https://img.shields.io/badge/Tech-Python%20%2F%20Pillow-00ff00?style=for-the-badge&logo=python" />
...
| Feature | Description |
| :--- | :--- |
| 🤝 **Squad-Split** | Built-in Splitwise logic with UPI deep-linking for instant settlement. |
| 📊 **Neon Analytics** | Heatmaps and contribution graphs that track your savings streaks. |
| 📱 **UPI Deep-Sync** | Auto-categorization of spends (Zomato 🍜, Amazon 👟) via SMS/Statement parsing. |
| 🕵️ **Privacy First** | Local-first storage. Your data stays on your device. No bank logins required. |

---

## 🎨 Visual Identity: Midnight Neon

> "Dark mode isn't a feature, it's a personality."

* **Canvas:** Deep Carbon (`#0A0A0B`)
* **Accents:** Electric Purple (`#BB86FC`) & Cyber Cyan (`#03DAC6`)
* **UI Style:** Glassmorphism with 15% opacity frosted panels.
